...
def check_requirements(dist, attr, value):
    """Verify that install_requires is a valid requirements.txt list"""
    try:
...
class Distribution(Distribution_parse_config_files, _Distribution):
    ...
    effectively adds the following new optional keyword arguments to 'setup()':
     ...
     'extras_require' -- a dictionary mapping names of optional "extras" to the
        ...
        additional requirements.txt will be installed if needed.
    ...
    def _convert_extras_requirements(self):
        """
        Convert requirements.txt in `extras_require` of the form
    ...
    def _move_install_requirements_markers(self):
        """
        Move requirements.txt in `install_requires` that are using environment
    ...
    def fetch_build_eggs(self, requires):
        """Resolve pre-setup requirements.txt"""
...
class Feature:
    ...
    **deprecated** -- The `Feature` facility was never completely implemented
    ...
    def include_in(self, dist):
        """Ensure feature and its requirements.txt are included in distribution
