...
def install(requirements, requirements_file=None,
    ...
    :param requirements: A list of requirements.txt or wheel files to install.
    :param requirements_file: A file containing requirements.txt to install.
    ...
    # If there is a requirements.txt file, add it to the list of requirements.txt
    if requirements_file:
        # If the file doesn't exist, search for it in wheel_dirs
        # This allows standard requirements.txt files to be stored with the
        # wheels.
...
def parser():
    ...
    install_parser.add_argument('requirements.txt', nargs='*',
    ...
    install_parser.add_argument('--requirements.txt-file', '-r',
                                help="A file containing requirements.txt to "
                                "install.")
