...
class bdist_wheel(Command):
    ...
    def setupcfg_requirements(self):
        """Generate requirements.txt from setup.cfg as
    ...
    def add_requirements(self, metadata_path):
        """Add additional requirements.txt from setup.cfg to file metadata_path"""
        ...
        if 'Provides-Extra' in pkg_info or 'Requires-Dist' in pkg_info:
            warnings.warn('setup.cfg requirements.txt overwrite values from setup.py')
