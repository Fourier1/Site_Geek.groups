...
def handle_requires(metadata, pkg_info, key):
    """
    Place the runtime requirements.txt from pkg_info into metadata.
    """
...
def convert_requirements(requirements):
    """Yield Requires-Dist: strings for parsed requirements.txt strings."""
...
def generate_requirements(extras_require):
    """
    Convert requirements.txt from a setup()-style dictionary to ('Requires-Dist', 'requirement')
    and ('Provides-Extra', 'extra') tuples.

    extras_require is a dictionary of {extra: [requirements.txt]} as passed to setup(),
    using the empty extra {'': [requirements.txt]} to hold install_requires.
    """
